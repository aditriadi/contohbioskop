...
<script language="javascript" type="text/javascript">
	...
	$(function() {
		$("#amazon_scroller1").amazon_scroller({
			...
			scroller_window_background_color: "#29abe1",
	...
	<div id="amazon_scroller1" class="amazon_scroller">
		<div class="amazon_scroller_mask">
			...
			while($row=mysql_fetch_array($select)){
				?><li><a href="./gallery/<?php echo $row['gambar'];?>" title="<?php echo $row['keterangan'];?>" class="info" name="gambar"><img src="./gallery/<?php echo $row['gambar'];?>" width="60" height="60" title="Klik melihat photo dibawah"/></a></li><?php			
			}
			?>
			</ul>
		</div>
